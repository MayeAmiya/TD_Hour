...
struct game_coord_2d
{
    ...
    game_coord_2d(game_scalar x_, game_scalar y_) noexcept : x(x_), y(y_) {}
};
...
struct game_coord_3d
{
    ...
    game_coord_3d(game_scalar x_, game_scalar y_, game_scalar z_) noexcept : x(x_), y(y_), z(z_) {}
};

// ── SIMD batch types (2-wide Vec2q) ────────────────────────────────────
struct game_coord_2d_x2
{
    q32_32x2 x;
    q32_32x2 y;
};

struct game_coord_3d_x2
{
    q32_32x2 x;
    q32_32x2 y;
    q32_32x2 z;
